        ...
        VStack(alignment: .leading, spacing: 12)
        {
            ...
            VStack(spacing: 1)
            {
                ...
                ScrollView
                {
                    ...
                    {
                        ForEach(Array(workoutSets.enumerated()), id: \.offset)
                        { index, set in
                            WorkoutSetRow(
                                setNumber: index + 1,
                                workoutSet: set,
    ...
    var body: some View
    {
        VStack(spacing: 0)
        {
            ...
            if isExpanded
            {
                VStack(spacing: 1)
                {
                    ForEach(Array(workoutSet.consecutiveSwims.enumerated()), id: \.offset)
                    { swimIndex, consecutiveSwim in
                        ...
                        {
                            ForEach(Array(consecutiveSwim.laps.enumerated()), id: \.offset)
                            { lapIndex, lap in
                                HStack
                                {
