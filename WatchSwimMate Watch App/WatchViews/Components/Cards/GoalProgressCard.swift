...
struct GoalProgressCard: View
{
    ...
    // sizing
    private var iconSize: CGFloat { isCompact ? 12 : 16 }
    private var iconFrameWidth: CGFloat { isCompact ? 16 : 22 }
    private var cardPadding: CGFloat { isCompact ? 6 : 8 }
    private var cardVerticalPadding: CGFloat { isCompact ? 6 : 8 }
    private var textSize: CGFloat { isCompact ? 10 : 12 }
    private var percentageSize: CGFloat { isCompact ? 10 : 13 }
