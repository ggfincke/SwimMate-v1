...
struct GoalProgressBar: View 
{
    ...
    private var progressBarWidth: CGFloat { isCompact ? 110 : 160 }
    private var progressBarHeight: CGFloat { isCompact ? 8 : 12 }
    private var cornerRadius: CGFloat { isCompact ? 4 : 6 }
